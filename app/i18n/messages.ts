...
export const messages = {
  en: {
    ...
    tasks: {
      ...
      selectionHint: "Click a task row to select it",
    ...
    calendar: {
      ...
      descriptionPh: "Optional details",
      dateLabel: "Date",
      startLabel: "Start",
      endLabel: "End",
      allDay: "All day",
      ...
      linkedTaskLabel: "Linked task ID",
      linkedTaskPh: "Optional task id",
    ...
    auth: {
      ...
      passwordLengthHint: "Password must be between 8 and 24 characters.",
      loginTitle: "Login to",
      ...
      nameMaxLength: "Name cannot exceed 40 characters.",
      emailMaxLength: "Email cannot exceed 40 characters.",
      passwordMinLength: "Password must have at least 8 characters.",
      passwordMaxLength: "Password cannot exceed 24 characters.",
  ...
  pl: {
    ...
    tasks: {
      ...
      status: "Status",
      tasksHeading: "Taski",
      multiSelectMode: "Wielokrotny wybór",
      selectAllVisible: "Zaznacz wszystkie widoczne",
      selectedCount: "Zaznaczone: {count}",
      clearSelection: "Wyczyść zaznaczenie",
      selectionHint: "Kliknij wiersz taska, aby go zaznaczyć",
      selectTaskAria: "Zaznacz task: {title}",
      deleteSelected: "Usuń zaznaczone",
      deleteSelectedConfirm:
        "Czy na pewno chcesz usunąć {count} zaznaczonych tasków?",
    ...
    calendar: {
      title: "Kalendarz",
      addToggle: "Dodaj wydarzenie",
      addTitle: "Nowe wydarzenie",
      editTitle: "Edytuj wydarzenie",
      titleLabel: "Tytul",
      titlePh: "Wpisz tytul",
      descriptionLabel: "Opis",
      descriptionPh: "Opcjonalne szczegoly",
      dateLabel: "Data",
      startLabel: "Start",
      endLabel: "Koniec",
      allDay: "Calodniowe",
      ...
      linkedTaskLabel: "ID taska",
      linkedTaskPh: "Opcjonalne id taska",
      assigneeLabel: "Przypisany",
      assigneePh: "Nazwa uzytkownika",
      submit: "Zapisz",
      update: "Aktualizuj",
      delete: "Usun",
      cancel: "Anuluj",
      ...
      prev: "Poprzedni",
      next: "Nastepny",
      emptyDay: "Brak wydarzen",
      addSuccess: "Wydarzenie dodane",
      updateSuccess: "Wydarzenie zaktualizowane",
      deleteSuccess: "Wydarzenie usuniete",
      fillAll: "Uzupelnij wymagane pola",
      networkError: "Blad sieci",
      weekdays: ["Pon", "Wt", "Sr", "Czw", "Pt", "Sob", "Nd"],
      months: [
        "Styczen",
        "Luty",
        "Marzec",
    ...
    auth: {
      ...
      passwordLengthHint: "Hasło musi mieć od 8 do 24 znaków.",
      ...
      nameMaxLength: "Nazwa nie może przekraczać 40 znaków.",
      emailMaxLength: "Email nie może przekraczać 40 znaków.",
      passwordMinLength: "Hasło musi mieć co najmniej 8 znaków.",
      passwordMaxLength: "Hasło nie może przekraczać 24 znaków.",
