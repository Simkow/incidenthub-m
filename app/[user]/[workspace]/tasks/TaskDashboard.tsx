    ...
    >
      ...
      <section className="py-2 w-full h-full">
        <main className="w-full h-full border-y border-l rounded-l-xl border-[#2e2e2e] bg-[#181818] flex flex-col items-center p-4 gap-8 text-white relative">
          {/* top bar */}
          <section className="w-full h-10 rounded-xl border border-[#2e2e2e] flex items-center px-3 body-text text-xs gap-4">
            <button
            ...
            <input
              ...
              className="w-72 px-2 py-1 rounded-lg border border-[#2e2e2e] focus:border-neutral-300 focus:outline-none"
            />
          </section>
          ...
          <section className="w-full h-full flex flex-col gap-1">
            ...
            <main className="border-t border-[#2e2e2e] w-full h-full">
              {taskView === "All" ? (
