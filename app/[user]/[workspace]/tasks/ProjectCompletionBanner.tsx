    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-50 flex items-start pt-52 md:pt-80 justify-center bg-black/20 backdrop-blur-sm"
          onMouseDown={(e) => {
        ...
        >
          <motion.div
            ...
            className="w-full max-w-xl rounded-xl bg-(--ws-surface) border border-(--ws-border)"
