        ...
        <main className="w-full md:min-h-full border-y border-l rounded-l-xl border-[color:var(--ws-border)] bg-[color:var(--ws-surface)] flex flex-col items-center p-4 gap-8 text-[color:var(--ws-fg)] relative">
          ...
          <section className="w-full rounded-xl border border-[color:var(--ws-border)] flex flex-wrap items-center px-3 py-2 body-text text-xs gap-2">
            ...
            <input
              ...
              className="w-full md:w-72 px-2 py-1 rounded-lg border border-[color:var(--ws-border)] bg-transparent text-[color:var(--ws-fg)] placeholder:text-[color:var(--ws-fg-muted)] focus:outline-none"
            />
          </section>
